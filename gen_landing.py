...
const features = [
  { icon: MessageCircle, emoji: "\U0001f4ac", title: "AI Health Chat",
    desc: "Talk to CareAI, powered by GPT-4o-mini. Get warm health guidance anytime. Voice input & text-to-speech included.",
    color: "bg-purple-100 text-purple-700" },
  { icon: Stethoscope, emoji: "\U0001fa7a", title: "Symptom Checker",
    desc: "Select symptoms from 30+ options. Match against 9 conditions with confidence scores & specialist recs.",
    color: "bg-blue-100 text-blue-700" },
  { icon: Activity, emoji: "\u2764\ufe0f", title: "Health Risk Predictors",
    desc: "Assess heart disease risk, diabetes likelihood & calculate your BMI. Quick heuristic wellness estimates.",
    color: "bg-rose-100 text-rose-700" },
  { icon: Pill, emoji: "\U0001f48a", title: "Medicine Reminders",
    desc: "Log medications with dosage & schedule. Morning, afternoon & night tracking so you never miss a dose.",
    color: "bg-pink-100 text-pink-700" },
  { icon: CalendarClock, emoji: "\U0001f4c5", title: "Appointments",
    desc: "Book & manage doctor visits. Keep every appointment organized with date, time & reason.",
    color: "bg-indigo-100 text-indigo-700" },
  { icon: Users, emoji: "\U0001f198", title: "Emergency Contacts",
    desc: "Store loved ones & reach instantly. One-tap call or SMS from SOS button - critical when seconds matter.",
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-5 lg:px-8 pt-6 lg:pt-14 pb-16 lg:pb-24 grid lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-7">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/80 text-xs font-bold text-rose-700 border border-rose-200 shadow-sm">
            <Sparkles className="w-3.5 h-3.5 text-rose-500" /> Your gentle health companion \U0001f338
          </span>
          ...
          <h1 className="font-display mt-5 text-5xl sm:text-6xl lg:text-7xl leading-tight">
            ...
            <span className="text-slate-900"> \U0001f90d</span>
          </h1>
          ...
          <p className="mt-5 text-lg text-slate-600 max-w-xl leading-relaxed">
            ...
            manage medicines &amp; appointments, and keep loved ones one tap away \u2014
          ...
          <div className="mt-10 grid sm:grid-cols-3 gap-3 max-w-xl">
            {[
              { icon: MessageCircle, t: "AI Chat", d: "GPT-4o powered", emoji: "\U0001f4ac" },
              { icon: Stethoscope, t: "Symptom Check", d: "30+ symptoms", emoji: "\U0001fa7a" },
              { icon: MapPin, t: "Nearby Care", d: "Hospitals near you", emoji: "\U0001f4cd" },
            ].map(({ icon: Icon, t, d, emoji }) => (
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-64 h-64 sm:w-72 sm:h-72 rounded-full bg-gradient-to-br from-rose-200 via-purple-200 to-blue-200 shadow-2xl flex items-center justify-center float-slow border-4 border-white">
                <div className="text-center">
                  <div className="text-7xl sm:text-8xl mb-2">\U0001fa7a</div>
                  <div className="font-display text-2xl sm:text-3xl text-slate-800">CareAI</div>
                  <div className="flex items-center justify-center gap-1 mt-2">
                    <span className="text-2xl">\U0001f60a</span>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-5 lg:px-8 pb-20">
        <div className="text-center mb-10">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/80 text-xs font-bold text-purple-700 border border-purple-200">
            <Sparkles className="w-3.5 h-3.5 text-purple-500" /> Everything you need \U0001f308
          </span>
          ...
          <p className="mt-3 text-slate-600 max-w-lg mx-auto">
            From AI conversations to emergency contacts \u2014 CareAI brings warmth, clarity, and care to every aspect of your health journey.
          </p>
        </div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
          {features.map(({ icon: Icon, emoji, title, desc, color }) => (
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-5 lg:px-8 pb-20">
        <div className="glass-strong rounded-[3rem] p-10 md:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative">
            <span className="text-6xl mb-4 block">\U0001f49a</span>
            ...
            <p className="mt-4 text-slate-600 max-w-md mx-auto text-lg">
              Join CareAI today \u2014 it's free, it's warm, and it's always here when you need a gentle hand.
            </p>
...
p.write_text(jsx, 'utf-8')
print('Written successfully')
print('Length:', len(jsx))
