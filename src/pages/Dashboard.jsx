...
import { MessageCircle, Stethoscope, Activity, Pill, CalendarClock, MapPin, Users, Sparkles, ArrowRight } from "lucide-react";
...
export default function Dashboard() {
  ...
  const quick = [
    { to: "/app/chat", label: "Talk to CareAI", desc: "Get gentle guidance", icon: MessageCircle, color: "bg-rose-100 text-rose-700" },
