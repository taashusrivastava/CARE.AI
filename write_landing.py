...
jsx_chunks.append('''import React from "react";
...
const features = [
  { icon: MessageCircle, emoji: "\U0001f4ac", title: "AI Health Chat",
    desc: "Talk to CareAI, powered by GPT-4o-mini. Get warm health guidance anytime. Voice input included.",
  ...
  { icon: Activity, emoji: "\u2764\ufe0f", title: "Health Risk Predictors",
    desc: "Assess heart disease risk, diabetes likelihood and calculate your BMI. Quick estimates.",
...
# Hero section with properly nested divs
jsx_chunks.append('''
        ...
        <div className="glass-strong rounded-[3rem] p-10 md:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="mt-4 text-slate-600 max-w-md mx-auto text-lg">
              Join CareAI today \u2014 it is free, it is warm, and it is always here when you need a gentle hand.
            </p>
...
output = ''.join(jsx_chunks)
p = pathlib.Path('src/pages/Landing.jsx')
p.write_text(output, 'utf-8')
print(f"Written {len(output)} bytes to Landing.jsx")
